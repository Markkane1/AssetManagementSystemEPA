...
namespace AssetManagement.Application.Interfaces
{
    ...
    {
        Task<IEnumerable<AssetItem>> GetAllAssetItemsAsync(string userRole, int? userLocationId);
        ...
        Task<IEnumerable<AssetItem>> GetUnassignedAssetItemsAsync();
        ...
        Task<IEnumerable<AssetSummaryDto>> GetAssetSummaryByLocationAsync();
        Task<IEnumerable<CategorySummaryDto>> GetAssetSummaryByCategoryAsync();
        Task<IEnumerable<AssetStatusReportDto>> GetAssetStatusReportAsync();
